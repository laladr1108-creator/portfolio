const projectData = {
  ...
  kbju: {
    title: "КБЖУ Planner",
    text: "Мой проект про питание: расчет дневной нормы, распределение белков, жиров и углеводов, список приемов пищи и прогресс по целям. Здесь я показываю калькуляторы, локальные данные и понятный health UI.",
    href: "./projects/06-kbju-planner/index.html",
    tags: ["кбжу", "калькулятор", "питание"]
  },
  exclusive: {
    title: "Exclusive Partners",
    text: "Панель для партнерской работы: карточки партнеров, уровни, pipeline, задачи и быстрый расчет потенциальной выручки. Проект показывает CRM-логику и аккуратный интерфейс для B2B-сценариев.",
    href: "./projects/07-exclusive-partners/index.html",
    tags: ["crm", "partners", "b2b"]
  }
};
